//--------------------------------------------------------------------------------------------------------------------\\
                                                       VARIABLE TYPES
//--------------------------------------------------------------------------------------------------------------------\\
// dedine [ any name ] |spase| this function
// Example: #define ex std::cout << "Hello" << std::endl; |ex| = name; |std::cout << "Hello" << std::endl;| = function;
